...
<div id="main_container">
  ...
  <div id="main_content">
    ...
    <!-- end of menu tab -->
    <div class="crumb_navigation"> Navigation: <span class="current">Change Name</span> </div>
  ...
  <div class="border_box">
    ...
    <div class="center_content">
          <div class="center_title_bar">Change Name:</div>
      <div class="prod_box_big">
        ...
        <div class="center_prod_box_big">
          ...
          <div class="contact_form">
            <div class="form_row">
              <label class="postad"><strong>Enter new Name:</strong></label>
