...
<!--     </div> -->
 ...
 <div id="logo">
  ...
  <div id="main_content">
    ...
    <!-- end of menu tab -->
    <div class="crumb_navigation"> Navigation: <span class="current">Contact Us</span> </div>
        ...
        <div class="center_prod_box_big">
          ...
          <div class="contact_form">
            ...
            <div class="form_row">
              ...
              <input type="text" class="contact_input"  name="comp"/>
            </div>
            <div class="form_row">
  ...
  <!-- end of main content -->
   <div class="footer">
    ...
    <div class="right_footer"> 
	    <% if(m==null){ %> <a href="index.jsp">Home</a><% } else { %> <a href="homepage.jsp">Home</a> <%  } %> |<a href="AboutUs.jsp">About</a> |<a href="contactus.jsp">Contact us</a>
	    </div>
  </div>
</div>
</div>
