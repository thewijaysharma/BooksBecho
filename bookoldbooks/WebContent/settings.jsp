...
<!--     </div> -->
  ...
  <div id="main_content">
    ...
    <!-- end of menu tab -->
    <div class="crumb_navigation"> Navigation: <span class="current">Settings</span> </div>
    ...
    <div class="center_content">
              <div class="center_title_bar">Settings</div>
    ...
    <br>
            <%  String msgpass= (String)request.getAttribute("msgpass");
              ...
              <% } %>	
               ...
               <%  String msgcity= (String)request.getAttribute("msgcity");
                if(msgcity!=null){  	%>
              ...
              <% } %>	
               ...
               <%  String msgname= (String)request.getAttribute("msgname");
                if(msgname!=null){  	%>
  ...
  <br>
    <ul>
    <li><a href="changepass.jsp">Update password</a></li>
         <li><a href="changename.jsp">Edit Name</a></li>
     <li><a href="changecity.jsp">Change your city</a></li>
</ul>   
    </div>
  </div>
  </div>
