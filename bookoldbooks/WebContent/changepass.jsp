...
<!--     </div> -->
  ...
  <div id="main_content">
    ...
    <!-- end of menu tab -->
    <div class="crumb_navigation"> Navigation: <span class="current">Change Password</span> </div>
    <div class="left_content">
      ...
      <ul class="left_menu">
        ...
        <li class="odd"><a href="getBookDeta-ilsServlet?category=Others">Others</a></li>
      </ul>
      ...
      <div class="prod_box_big">
        ...
        <div class="center_prod_box_big">
          ...
          <div class="contact_form">
            <div class="form_row">
   			  <label class="postad"><strong>Enter old password:</strong></label>
              <input type="text" class="contact_input" name="old" />
              </div>
            <div class="form_row">
              <label class="postad"><strong>Enter new password:</strong></label>
              <input type="password" class="contact_input" name="new"  />
            </div>
            <div class="form_row">
