...
<div id="logo">
  ...
  <form action="filtercity?subject=<%= rs.getString("subject") %>">
  <ul>
   <li> <strong>City:</strong>
     ...
     %>
      ...
      <div class="prod_box">
        ...
        <div class="prod_details_tab">
         <a href="onebookdetails?id=<%= rs.getString("bookid") %>" class="prod_details">Details</a> </div>
      </div>
    ...
    <!-- end of center content -->   
      ...
      <img src="images/oldbooks.png" alt="" width="190" height="600" />
    </div>   
