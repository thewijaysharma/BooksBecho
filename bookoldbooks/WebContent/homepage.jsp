...
<!--     </div> -->
  ...
  <div id="main_content">
    ...
    <!-- end of menu tab -->
    <div class="crumb_navigation"> Navigation: <span class="current">Homepage</span> </div>
    ...
    <div class="center_content">
          <div class="center_title_bar">Homepage</div>
          <div class="welcome">
          <img src="images/welcome.png" width="530" height="130">
          </div>
            <div class="successmsg">
            <%  String msgad= (String)request.getAttribute("msgad");
                if(msgad!=null){  	%>
				<br>
              <%= msgad %>  
  ...
  <div class="post_ad">
  <br><ul>
    <li><a href="postnewad.jsp">Click here to Post an ad</a></li>
     <li><a href="ShowUploadedAds?email=<%=m %>">Delete your ad(s)</a></li>
   ...
   <div class="right_content">
      <img src="images/oldbooks.jpg" alt="" width="180" height="500" />
    </div>
